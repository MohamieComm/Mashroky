...
export default function FlightTravelerDetails() {
  ...
  const handleSubmit = async () => {
    ...
    setError("");
    try {
      const priceRes = await apiPost("/api/flights/price", { flightOffers: checkout.offers });
      ...
      const paymentRes = await apiPost("/api/payments/create", {
          amount: total,
          currency,
            ...
            {travelers.map((traveler, index) => (
              <div key={index} className="bg-card rounded-2xl p-6 shadow-card">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label>الجنسية (رمز الدولة مثل SA)</Label>
                  ...
                  <div>
                    ...
                    <Input type="email" value={traveler.email} onChange={(e) => updateTraveler(index, { email: e.target.value })} placeholder="بريدك الإلكتروني" />
                  ...
                  <div>
                    ...
                    <Input value={traveler.phoneNumber} onChange={(e) => updateTraveler(index, { phoneNumber: e.target.value })} placeholder="5XXXXXXXX" dir="ltr" />
