...
const fallbackTours: TourResult[] = [
  {
    ...
    priceTotal: 180,
    currency: "SAR",
    image: "https://images.unsplash.com/photo-1699954669485-812988f5c2db?auto=format&fit=crop&w=800&q=80",
    summary: "زيارة البلدة القديمة والكورنيش مع مرشد محلي وتجربة تراثية متكاملة تشمل سوق العلوي والمباني التاريخية.",
    meetingPoint: "بوابة مكة التاريخية - البلد",
  },
  {
    id: "tour-2",
    ...
    priceTotal: 650,
    currency: "SAR",
    image: "https://images.unsplash.com/photo-1578922746465-b0a1db3e2f8e?auto=format&fit=crop&w=800&q=80",
    summary: "مواقع تراثية وجولات مدائن صالح مع أنشطة صحراوية وتجارب ثقافية وإقامة ليلة في مخيم فاخر.",
    meetingPoint: "مطار العلا الدولي",
  },
  {
    id: "tour-3",
    ...
    summary: "رحلة بحرية مع غطس خفيف وتجربة استرخاء على الشاطئ. تشاهد الشعاب المرجانية والأسماك الملونة.",
    meetingPoint: "مرسى ينبع البحري",
  },
  {
    id: "tour-4",
    name: "جولة ليلية في الرياض",
    city: "الرياض",
    category: "ثقافية",
    rating: 4.6,
    duration: "4 ساعات",
    priceTotal: 150,
    currency: "SAR",
    image: "https://images.unsplash.com/photo-1663900108404-a05e8bf82cda?auto=format&fit=crop&w=800&q=80",
    summary: "جولة مسائية لاستكشاف معالم الرياض الحديثة مع زيارة برج المملكة والبوليفارد ومنطقة الدرعية.",
    meetingPoint: "برج المملكة - الدور الأرضي",
  },
  {
    id: "tour-5",
    name: "مغامرة جبال أبها",
    city: "أبها",
    category: "طبيعة",
    rating: 4.7,
    duration: "6 ساعات",
    ...
    summary: "رحلة إلى السودة وجبل ذرة مع تلفريك ومشي في المدرجات الزراعية والتقاط أجمل الصور.",
    meetingPoint: "منتزه السودة",
  },
  {
    id: "tour-6",
    name: "رحلة عمرة مميزة",
    city: "مكة المكرمة",
    category: "روحانية",
    rating: 4.9,
    duration: "3 أيام",
    ...
    summary: "باقة عمرة شاملة مع إقامة قريبة من الحرم المكي ونقل مكيف وإرشاد ديني.",
    meetingPoint: "فندق الإقامة - مكة المكرمة",
  },
];
