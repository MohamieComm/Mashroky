export const stats = [
  { label: "رحلات ناجحة", value: "10K+" },
  { label: "وجهة حول العالم", value: "500+" },
  { label: "ساعات دعم يوميًا", value: "24/7" },
];

export const seasonalOffers = [
  {
    id: 1,
    title: "شتاء دبي المشرق",
...
export const honeymoonOffers = [
  {
    id: 1,
    title: "ليالٍ رومانسية في المالديف",
    location: "المالديف",
    duration: "7 ليالٍ",
    price: "9,200",
...
export const studyOffers = [
  ...
  {
    id: 3,
    title: "تعلّم الإنجليزية في سيدني",
    location: "أستراليا",
    duration: "8 أسابيع",
    price: "10,400",
...
export const studyDestinations = [
  {
    ...
    focus: "اللغة الإنجليزية والتعليم الجامعي",
    highlights: ["جامعات عريقة", "مدن طلابية متنوعة", "خيارات سكن مرنة"],
  },
  {
    id: 2,
    name: "الولايات المتحدة",
    focus: "برامج أكاديمية مرنة وتخصصات واسعة",
    highlights: ["خيارات تخصصية واسعة", "حياة جامعية نشطة", "شبكات خريجين قوية"],
  },
  {
    id: 3,
    name: "كندا",
    focus: "بيئة آمنة وتنوع ثقافي",
    highlights: ["كو-أوب وفرص تدريب", "تأشيرات ما بعد الدراسة", "مدن صديقة للطلاب"],
  },
  {
    id: 4,
    name: "أستراليا",
    focus: "تعليم عملي وبرامج لغة مكثفة",
    highlights: ["جودة تعليم عالية", "طقس معتدل", "أنشطة خارجية"],
  },
  {
    id: 5,
    name: "أيرلندا",
...
export const travelGuideSections = [
  {
    title: "خطط لأفضل عروض رحلات سياحية من السعودية",
    intro:
      "نساعدك في بناء خطة سفر متكاملة تشمل الطيران والفندق والأنشطة، مع توضيح ما يشمله السعر وما لا يشمله.",
    items: [
      "حدد الموسم الأنسب لوجهتك بناءً على الطقس والفعاليات.",
      "قارن بين الباقات الشاملة لتوفير وقتك وميزانيتك.",
      "اختر برنامجًا يتضمن المواصلات والتنقلات المحلية.",
      "أضف التأمين على السفر وخدمات المطار عند الحاجة.",
    ],
  },
  {
    title: "اختر الوجهة المثالية حسب طبيعة الرحلة",
    intro:
      "سواءً كانت الرحلة عائلية أو شهر عسل أو دراسة بالخارج، لدينا توصيات مبنية على التجارب والموسم.",
    items: [
      "الوجهات العائلية: دبي، جورجيا، صلالة، كوالالمبور.",
      "شهر العسل: المالديف، سانتوريني، كابادوكيا.",
      "الدراسة بالخارج: لندن، دبلن، تورونتو، سيدني.",
      "الرحلات القصيرة: الرياض، جدة، أبها، البحر الأحمر.",
    ],
  },
  {
    title: "نصائح سريعة قبل الحجز",
    intro:
      "هذه النقاط تساعدك على اتخاذ قرار أفضل وتفادي التكاليف غير المتوقعة.",
    items: [
      "تحقق من متطلبات التأشيرة وجواز السفر قبل الدفع.",
      "احتفظ بنسخة إلكترونية من التذاكر والحجوزات.",
      "اختر سياسات إلغاء مرنة إذا كانت رحلتك قابلة للتغيير.",
      "اسأل عن الرسوم الإضافية للمواصلات أو الأنشطة.",
    ],
  },
];
...
export const adminBenefitCards = [
  {
    ...
    description: "أكمل إجراءات السفر عبر الإنترنت قبل وصولك إلى المطار.",
  },
  {
    title: "إدارة حجوزاتك",
    description: "اعرض مسار رحلتك أو قم بإلغاء حجزك بسهولة.",
  },
  {
    title: "حمّل تطبيق مشروك",
    description: "احصل على أسعار مميزة وتحديثات فورية عبر التطبيق.",
  },
];
