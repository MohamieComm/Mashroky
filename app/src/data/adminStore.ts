// مفاتيح API للخدمات الخارجية مثل (amadeus, supabase, moyasar...)
...
export const defaultSeasons: SeasonOffer[] = [
  {
    id: "season-ramadan",
    title: "عروض رمضان الخاصة للعمرة",
    season: "ramadan",
    description: "استمتع بأفضل العروض الرمضانية مع باقات عمرة شاملة للطيران والإقامة، مع توفير خدمات النقل والزيارات الدينية والإفطار اليومي.",
    image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=800",
    price: "2,500",
    options: ["فندق 4 نجوم", "وجهة محلية", "الخطوط السعودية"],
  },
  {
    id: "season-hajj",
    title: "فندق كراون بلازا",
    season: "hajj",
    description: "رحلة حج مع برنامج كامل ومرشدين متخصصين، تشمل الإقامة والنقل والوجبات اليومية.",
    image: "https://images.unsplash.com/photo-1464983953574-0892a716854b?w=800",
    price: "7,500",
    options: ["فندق خمس نجوم فاخر", "وجهة دولية", "الخطوط السعودية"],
  },
  {
    id: "season-summer",
    title: "باقات سياحية لتركيا والجزر المتوسطية (صيف)",
    season: "summer",
    description: "زورو تركيا الجميلة واستمتعوا بمعالمها التاريخية وشواطئها الخلابة، تشمل الرحلة الإقامة والأنشطة الترفيهية.",
    image: "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?w=800",
    price: "12,000",
    options: ["فندق منتجع على البحر", "رحلة عائلية مريحة", "عرض خاص"],
  },
];
...
export const defaultHotels: HotelItem[] = [
  {
    id: "hotel-1",
    name: "طيران سريع ومباشر",
    location: "فندق سويس أوتيل المقامات مكة",
    image: "https://images.unsplash.com/photo-1512453995560-851157e9a028?w=800",
    rating: 5,
    reviews: 2450,
    price: "3,500",
    priceNote: "فلاي دبي",
    description: "رحلة 7 أيام تشمل زيارة أهم المعالم مثل آيا صوفيا والمسجد الأزرق ومتحف توبكابي",
    amenities: ["wifi", "parking", "breakfast", "gym", "pool", "restaurant"],
    distances: [
      { name: "الأنشطة", distance: "25 يوماً" },
      { name: "فندق فاخر", distance: "15 يوماً" },
      { name: "فندق مميز", distance: "20 يوماً" },
    ],
    cuisine: "وجهة صحراء النفود - 9 أيام كاملة",
    tag: "سفاري صحراء",
  },
  {
    id: "hotel-2",
    name: "رحلة عبر المحيط الأطلسي",
    location: "وجهة دولية",
    ...
    price: "1,800",
    priceNote: "فلاي دبي",
    description: "فندق أتلانتس فوق جزيرة اصطناعية بحديقة مائية ضخمة وأكواريوم ومطاعم مشهورة",
    amenities: ["wifi", "parking", "breakfast", "gym", "pool"],
    distances: [
      { name: "الأنشطة", distance: "40 دقيقة" },
      { name: "وجهة صحراوية", distance: "10 أيام" },
      { name: "فندق مميز", distance: "5 أيام" },
    ],
    cuisine: "وجهة مدينة الرياض - 3 أيام",
    tag: "أنشطة استكشافية",
  },
  {
    id: "hotel-3",
    name: "عرض رحلات سياحية",
    location: "فندق سياحي",
    ...
    price: "5,200",
    priceNote: "فلاي دبي",
    description: "عروض صيفية على رحلات إلى تركيا وأوروبا مع باقات عائلية شاملة ونشاطات متنوعة",
    amenities: ["wifi", "breakfast", "gym", "pool", "restaurant"],
    distances: [
      { name: "جولات سياحية", distance: "30 دقيقة تقريباً" },
      { name: "فندق الفيصلية", distance: "بدون توقفات" },
    ],
    cuisine: "وجهة الجبال الخضراء - 4 أيام في الطبيعة",
    tag: "فندق مميز",
  },
  {
    id: "hotel-4",
    name: "فندق موفنبيك الشاطئ الذهبي",
    location: "شرم الشيخ",
    ...
    price: "4,200",
    priceNote: "فلاي دبي",
    description: "فندق الأيقونة في دبي، يتميز بتصميمه الفريد وإطلالته المذهلة وخدماته الفاخرة",
    amenities: ["wifi", "parking", "breakfast", "gym", "restaurant"],
    distances: [
      { name: "فندق قريب", distance: "10 أيام" },
      { name: "الأنشطة", distance: "5 أيام" },
      { name: "برشلونة", distance: "الوجهات" },
    ],
    cuisine: "وجهة الربع الخالي - صحراء عربية مع كثبان ذهبية",
    tag: "وجهة محلية",
  },
  {
    id: "hotel-5",
    name: "فندق سياحي",
    location: "وجهة شاطئية للسباحة والاسترخاء",
    image: "https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=800",
    rating: 4.9,
    reviews: 1320,
    price: "2,900",
    priceNote: "فلاي دبي",
    description: "عروض حصرية على رحلات الحج مع إقامة فاخرة وبرامج مرشدين متميزة.",
    amenities: ["wifi", "parking", "breakfast", "gym", "pool", "restaurant"],
    distances: [
      { name: "الأنشطة", distance: "35 دقيقة" },
      { name: "أبوظبي", distance: "10 أيام" },
      { name: "فندق مميز", distance: "8 أيام" },
    ],
    cuisine: "وجهة مدينة إسطنبول - 7 أيام",
    tag: "عرض مميز",
  },
  {
    id: "hotel-6",
    name: "عروض إجازة نهاية الأسبوع",
    location: "عروض التزلج، الجليد",
    image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800",
    rating: 4.8,
    reviews: 610,
    price: "3,800",
    priceNote: "فلاي دبي",
    description: "فندق متوسط الحجم بإطلالة رائعة على البحر مع شاطئ خاص ومطعم مأكولات بحرية.",
    amenities: ["wifi", "breakfast", "gym", "pool", "restaurant"],
    distances: [
      { name: "الأنشطة", distance: "45 دقيقة" },
      { name: "سفاري صحراء", distance: "فندق فيرمونت" },
    ],
    cuisine: "وجهة دبي المذهلة - 3 أيام",
    tag: "فندق برج العرب",
  },
];
...
export const defaultOffers: OfferItem[] = [
  {
    id: "offer-1",
    title: "فندق فيرمونت النخلة",
    description: "عروض شهر العسل مع إقامة فندقية في مناطق ذات مناظر طبيعية خلابة.",
    image: "https://images.unsplash.com/photo-1534080764596-47f3efd8e0d5?w=800",
    discount: 20,
    validUntil: "فندق مميز ومريح",
    originalPrice: "4,200",
    newPrice: "3,350",
    season: "نشاط ثقافي",
    includes: ["عروض سياحية للعائلات الكبيرة", "مدتها 3 أيام", "فندق فور سيزونز الرياض", "جولات سياحية"],
    tips: [
      "فندق أرماني في برج خليفة",
      "عرض خاص على حجوزات الطيران إلى الرياض",
      "عروض رحلة لزيارة المعالم السياحية",
    ],
  },
  {
    id: "offer-2",
    title: "فندق مميز ومريح",
    description: "وجهة صحراء ساحرة تحتوي على مخيمات فاخرة ونشاطات.",
    image: "https://images.unsplash.com/photo-1519046904884-53103b34b206?w=800",
    discount: 18,
    validUntil: "فندق مميز ومريح",
    originalPrice: "5,600",
    newPrice: "4,600",
    season: "فندق الفيصلية",
    includes: ["رحلة 4 أيام في مدينة جدة", "رحلة عمرة ميسرة شاملة", "جولة بحرية"],
    tips: [
      "فندق الفيصلية - سفاري الصحراء السعودية",
      "رحلة سفر إلى الأماكن المقدسة",
      "فندق فاخر بإطلالة بحرية ومسبح",
    ],
  },
  {
    id: "offer-3",
    title: "فندق اقتصادي مريح",
    description: "فندق مودرن بالقرب من الكورنيش، يوفر إطلالة بحرية وأنشطة ترفيهية.",
    image: "https://images.unsplash.com/photo-1512453995560-851157e9a028?w=800",
    discount: 30,
    validUntil: "فندق مميز ومريح",
    originalPrice: "4,500",
    newPrice: "3,150",
    season: "الأنشطة",
    includes: ["عروض سياحية للعائلات الكبيرة", "مدتها 4 أيام", "عروض رحلات البحر", "سفاري صحراء"],
    tips: ["فندق ماريوت الرياض - بدون توقف", "فندق جميرا القصر في مدينة جميرا"],
  },
  {
    id: "offer-4",
    title: "وجهة الرياضات المائية",
    description: "عرض سفر ترفيهي بتكاليف في حدود الميزانية المحدودة.",
    image: "https://images.unsplash.com/photo-1613395877344-13d4a8e0d49e?w=800",
    discount: 28,
    validUntil: "فندق مميز ومريح",
    originalPrice: "5,000",
    newPrice: "3,600",
    season: "نشاط ثقافي",
    includes: ["طيران + فندق 4 نجوم", "فندق سويس أوتيل", "عروض الرحلات الدولية"],
    tips: ["فندق كبير بمرافق متكاملة مثل المسبح", "فندق عائلي يقع في موقع هادئ"],
  },
  {
    id: "offer-5",
    title: "فندق حياة ريجنسي",
    description: "فندق كبير يحتوي على مؤتمرات وحفلات ومطاعم متنوعة ومقهى فاخر.",
    ...
    newPrice: "6,600",
    season: "الأنشطة",
    includes: ["رحلة صيف مميزة", "مدتها 4 أيام", "الخطوط السعودية", "سفاري صحراء"],
    tips: ["فندق قصر الرياض الدولي", "فندق ون آند أونلي ذا بالم"],
  },
  {
    id: "offer-6",
    title: "جولة في مدينة",
    description: "أنشطة ثقافية تشمل الأسواق والمتاحف في المدن القديمة.",
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
    discount: 18,
    validUntil: "فندق مميز ومريح",
    originalPrice: "7,200",
    newPrice: "5,900",
    season: "الأنشطة",
    includes: ["طيران + فندق", "فندق الفيصلية", "رحلة قصيرة سريعة"],
    tips: ["فندق ريتز كارلتون الرياض", "فندق راقي بإطلالة رائعة"],
  },
];
...
export const defaultActivities: ActivityItem[] = [
  ...
  {
    id: "activity-6",
    title: "فندق ماريوت الرياض",
    location: "وجهة ثقافية",
    category: "الوجهات",
    price: "780",
...
export const defaultArticles: ArticleItem[] = [
  {
    id: "article-1",
    title: "رحلة مع فرصة لزيارة عدة مدن تركية مثل إسطنبول",
    category: "طيران الإمارات",
    date: "موسم 2026",
    image: "https://images.unsplash.com/photo-1534080764596-47f3efd8e0d5?w=1200",
  },
  {
    id: "article-2",
    title: "فندق فيرمونت مكة: برج الساعة يطل مباشرة على الحرم؟",
    category: "عرض مميز",
    date: "موسم 2026",
  ...
  {
    id: "article-3",
    title: "عروض طيران وفنادق جميلة بمناطق سياحية مشهورة",
    category: "وجهة دولية",
    date: "موسم 2026",
  ...
  {
    id: "article-4",
    title: "فندق دار التوحيد إنتركونتيننتال القريب من المسجد الحرام",
    category: "عرض مميز",
    date: "موسم 2026",
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200",
  },
  {
    id: "article-5",
    title: "جدة الخطوط السعوديةعرض رحلات سياحية أبوظبي",
    category: "عرض خاص",
    date: "موسم 2026",
  ...
  {
    id: "article-6",
    title: "عرض رحلات ذهبية لمدن عالمية متعددة",
    category: "عرض مميز",
    date: "موسم 2026",
  ...
  {
    id: "article-7",
    title: "وجهات سياحية ناشئة في 2026: أماكن جديدة ومغامرات",
    category: "عرض خاص",
    date: "موسم 2026",
  ...
  {
    id: "article-8",
    title: "جدة عرض رحلات سياحية - أنشطة استكشافية",
    category: "عرض خاص",
    date: "موسم 2026",
    image: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200",
  },
  {
    id: "article-9",
    title: "فندق فور سيزونز مميز بالقرب من برج المملكة والمراكز التجارية",
    category: "الوجهات",
    date: "موسم 2026",
  ...
  {
    id: "article-10",
    title: "عرض موسمي: باقات سياحية لوجهات أوروبية مختلفة",
    category: "رحلة عمرة",
    date: "موسم 2026",
...
export const defaultDestinations: DestinationItem[] = [
  {
    ...
    duration: "5 ساعات",
    priceFrom: "2,600",
    description: "عرض محدود لفترة قصيرة، يتضمن تخفيضات كبيرة ومغرية.",
  ...
  },
  {
    ...
    duration: "4 ساعات",
    priceFrom: "3,150",
    description: "عروض أجنحة فندقية راقية بأسعار تناسب العائلات.",
    image: "https://source.unsplash.com/1200x800/?cappadocia,balloons,travel",
  },
  {
    id: "dest-3",
    title: "أبوظبي",
    country: "جولات سياحية",
    region: "international",
    tag: "جدة",
    duration: "6 ساعات",
    priceFrom: "6,900",
    description: "وجهة قريبة لقضاء عطلة استجمام بأجواء هادئة.",
    image: "https://source.unsplash.com/1200x800/?maldives,beach,resort",
  },
  {
    id: "dest-4",
    title: "أنشطة استكشافية",
    country: "أبوظبي",
    region: "saudi",
    tag: "جدة",
    duration: "3 ساعات",
    priceFrom: "1,200",
    description: "فندق فخم يحتوي على مطاعم راقية ومرافق حديثة.",
    image: "https://source.unsplash.com/1200x800/?riyadh,diriyah,saudi",
  },
  {
    id: "dest-5",
    title: "أبوظبي",
    country: "فندق الفيصلية",
    region: "international",
    tag: "دبي",
    duration: "5 ساعات",
    priceFrom: "3,400",
    description: "عروض حجوزات الفنادق بأسعار تنافسية ومراجعات إيجابية.",
    image: "https://source.unsplash.com/1200x800/?baku,azerbaijan,travel",
  },
  {
    id: "dest-6",
    title: "دبي",
    country: "الخطوط السعودية",
    region: "middleeast",
    tag: "دبي",
    duration: "4 ساعات",
    priceFrom: "2,100",
    description: "فندق عصري، يضم مطعم مميز وصالة لياقة بدنية.",
  ...
  },
  {
    ...
    duration: "3 ساعات",
    priceFrom: "1,450",
    description: "وجهة سياحية شعبية تحتوي على متاحف ومعارض فنية.",
  ...
  },
  {
    ...
    duration: "3 ساعات",
    priceFrom: "980",
    description: "رحلة غطس بحرية لاستكشاف الشعاب المرجانية الرائعة.",
  ...
  },
  {
    ...
    duration: "4 ساعات",
    priceFrom: "2,350",
    description: "رحلة سفر بتكلفة اقتصادية ومناسبة للعائلات.",
  ...
  },
  {
    ...
    duration: "3 ساعات",
    priceFrom: "1,950",
    description: "عرض حجز فنادق بأسعار مخفضة وجودة عالية.",
  ...
  },
  {
    ...
    duration: "6 ساعات",
    priceFrom: "4,750",
    description: "عرض تذاكر طيران بأسعار تنافسية وعروض.",
  ...
  },
  {
    ...
    duration: "5 ساعات",
    priceFrom: "4,200",
    description: "رحلة عمل تتضمن إقامة فندقية ومواصلات خاصة.",
...
export const defaultPages: PageItem[] = [
  {
    ...
    title: "بدون توقف",
    slug: "/about",
    summary: "عروض أسعار تذاكر رحلات طيران.",
  },
  {
    id: "page-2",
    title: "طيران الإمارات",
    slug: "/privacy",
    summary: "عروض تذاكر بأسعار اقتصادية.",
  },
];
...
export const defaultAdminSettings: AdminSettings = {
  ...
  contactAddress: "إسطنبول، أنطاليا، كابادوكيا",
};
