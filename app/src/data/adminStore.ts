...
export const defaultSeasons: SeasonOffer[] = [
  {
    ...
    season: "ramadan",
    description: "باقة روحانية متكاملة تشمل إقامة فاخرة قريبة من الحرمين الشريفين مع خدمات تنقل مريحة وإفطار يومي. استمتع بأجواء رمضان الروحانية مع جولات تعريفية للمعالم المقدسة وبرنامج ديني مميز.",
    image: "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&w=1200&q=80",
    price: "2,500",
    options: ["إقامة 4 نجوم", "إفطار يومي", "تنقلات داخلية", "جولة للمعالم", "مرشد ديني"],
  },
  {
    id: "season-hajj",
    title: "برامج الحج المميزة",
    season: "hajj",
    description: "برامج حج متكاملة بإدارة احترافية تشمل السكن القريب من الحرم والمشاعر المقدسة، مع إعاشة كاملة وخدمات إرشاد ديني متخصصة. نوفر لك تجربة حج آمنة ومريحة بأعلى معايير الجودة والخدمة.",
    image: "https://images.unsplash.com/photo-1564769625905-50e93615e769?auto=format&fit=crop&w=1200&q=80",
    price: "7,500",
    options: ["سكن قريب من الحرم", "إعاشة كاملة", "خدمة المشاعر", "مرشد ديني معتمد", "نقل مكيف", "حقيبة حاج"],
  },
  {
    id: "season-summer",
    title: "مصايف أبها والباحة",
    season: "summer",
    description: "استمتع بالأجواء المعتدلة والطبيعة الخلابة في جنوب المملكة. جولات في منتزه السودة والحبلة مع إقامة فندقية فاخرة وأنشطة عائلية ممتعة تشمل التلفريك والمشي في الغابات.",
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=1200&q=80",
    price: "4,500",
    options: ["إقامة 5 ليالي", "جولات طبيعية", "مرشد محلي", "تنقلات داخلية", "أنشطة عائلية", "وجبات يومية"],
  },
];
...
export const defaultHotels: HotelItem[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=1200&q=80",
      "https://images.unsplash.com/photo-1663900108404-a05e8bf82cda?auto=format&fit=crop&w=1200&q=80",
    ],
    checkInTime: "3:00 PM",
    checkOutTime: "12:00 PM",
...
export const defaultOffers: OfferItem[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1699954669485-812988f5c2db?auto=format&fit=crop&w=1200&q=80",
    discount: 25,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1663900108404-a05e8bf82cda?auto=format&fit=crop&w=1200&q=80",
    discount: 20,
...
export const defaultActivities: ActivityItem[] = [
  ...
  },
  {
    ...
    category: "طبيعة",
    price: "260",
    image: "https://images.unsplash.com/photo-1578922746465-b0a1db3e2f8e?auto=format&fit=crop&w=1200&q=80",
    duration: "6 ساعات",
...
export const defaultDestinations: DestinationItem[] = [
  ...
  },
  {
    ...
    duration: "3 أيام",
    priceFrom: "2,300",
    description: "عاصمة نابضة بالحياة مع بوليفارد والدرعية وبرج المملكة وفعاليات موسم الرياض.",
    image: "https://images.unsplash.com/photo-1663900108404-a05e8bf82cda?auto=format&fit=crop&w=1200&q=80",
  },
  {
    id: "destination-3",
    ...
    duration: "2 أيام",
    priceFrom: "3,100",
    description: "موقع تراث عالمي يضم مدائن صالح وصخرة الفيل والبلدة القديمة مع تجارب صحراوية فريدة.",
    image: "https://images.unsplash.com/photo-1578922746465-b0a1db3e2f8e?auto=format&fit=crop&w=1200&q=80",
  },
  {
    id: "destination-4",
  ...
  },
  {
    ...
    duration: "4 أيام",
    priceFrom: "2,500",
    description: "أجواء جبلية معتدلة مع منتزهات السودة والحبلة وقرية رجال ألمع التراثية.",
    image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=1200&q=80",
  },
  {
    id: "destination-6",
