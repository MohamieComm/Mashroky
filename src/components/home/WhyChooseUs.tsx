import { Shield, Headphones, CreditCard, Award, Clock, Heart } from "lucide-react";

const features = [
  {
    icon: Shield,
    title: "حجز آمن 100%",
    description: "جميع معاملاتك محمية بأعلى معايير الأمان",
  },
  {
    icon: Headphones,
  ...
  },
  {
    icon: CreditCard,
    title: "دفع مرن",
    description: "خيارات دفع متعددة تناسب احتياجاتك",
  },
  {
    icon: Award,
    title: "أفضل الأسعار",
  ...
  },
  {
    icon: Clock,
    title: "حجز سريع",
    description: "أتمم حجزك في دقائق معدودة",
  },
  {
    icon: Heart,
    title: "تجربة مميزة",
